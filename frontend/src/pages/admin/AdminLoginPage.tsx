...
export function AdminLoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-app-bg px-4">
      ...
      >
        <h1 className="mb-1 text-xl font-semibold text-text-contrast">Admin Login</h1>
        <p className="mb-6 text-sm text-text-muted">Manage cashiers and retail performance</p>
